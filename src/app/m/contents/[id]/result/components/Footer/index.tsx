...
import ContentLike from '@/app/m/contents/[id]/result/components/Footer/Like';
import ContentShare, {
  ContentShareProps,
} from '@/app/m/contents/[id]/result/components/Footer/Share';
import {
  ContentFooterLayout as Layout,
  ContentFooterBox,
} from '@/app/m/contents/[id]/result/components/Footer/styled';
